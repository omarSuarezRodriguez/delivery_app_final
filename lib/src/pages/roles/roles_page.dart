...
class RolesPage extends StatelessWidget {
  RolesController controlador = Get.put(RolesController());
      ...
      body: Center(
        child: Container(
          ...
          child: ListView(
            ...
            children: controlador.user.roles != null
                ? controlador.user.roles!.map((Rol rol) {
                    return _cardRol(rol);
                  }).toList()
                : [],
          ),
  ...
  Widget _cardRol(Rol rol) {
    return GestureDetector(
      onTap: () => controlador.goToPage(rol),
      child: Column(
        children: [
          Container(
